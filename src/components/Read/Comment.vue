<template>
  <div class="comment">
    ...
    <div class="right" :class="'bgColor'+bgColor">
      <div class="user-name">
      ...
      <!-- <div class="hanlde-box">
                ...
                <div class="right">
                    ...
                    @click="handleStar">{{commentInfo.likeNum}}</div>
                    <div class="handle-item reply"
                    @click="handleReplyItem">{{commentInfo.replyNum}}</div>
                    <div class="handle-item more"
                    @click="handleMoreReply"></div>
                </div>
      </div>-->
    </div>
    <!-- <div class="bottom" v-if="isShowInput">
            <input type="text" placeholder="Write a reply" autofocus
            v-model="inputComment">
            <div class="send"
            @click="handleReply">SEND</div>
    </div>-->
  </div>
</template>
<script>
