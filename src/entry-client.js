            ...
            if (ms && ms.length > 0) {
                for (let index = 0; index < ms.length; index++) {
                    ...
                    if (element.name == 'description') {
                        element.content = "Free online books for story lovers. Popular novels for reading: romance stories, horror fictions, fantasy novels, mystery books & more. Recruiting novel writers, create your chapter！";
                    }
                }
            }
            window.document.getElementsByTagName("title")[0].innerText = 'Webfic';
        }
